...
const PLACES: {
  ...
  { place: 'Sierra Nevada', country: 'Spain', at: [37.297, -3.127], radius: 25 },
  ...
  { place: 'Santa Fe', country: 'Argentina', at: [-32.01, -62.06], radius: 30 },
  ...
  { place: 'Calamuchita, Córdoba', country: 'Argentina', at: [-32.68, -64.73], radius: 30 },
  { place: 'São Paulo', country: 'Brazil', at: [-23.4, -46.33], radius: 30 },
  ...
  { place: 'Ubud, Bali', country: 'Indonesia', at: [-8.47, 115.27], radius: 15 },
  ...
  { place: 'Murter', country: 'Croatia', at: [43.8, 15.64], radius: 25 },
]
